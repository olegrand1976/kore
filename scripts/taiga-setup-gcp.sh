...
echo "Header  : X-Taiga-Webhook-Secret (récupérer via Secret Manager, non affiché ici)"
echo "Récup   : gcloud secrets versions access latest --secret=kore-taiga-webhook-secret --project=${GCP_PROJECT_ID}"
